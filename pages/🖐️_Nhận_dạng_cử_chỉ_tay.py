...
from HandGesture.cvfpscalc import CvFpsCalc
from HandGesture.model import KeyPointClassifier
...
def main():
    ...
    keypoint_classifier = KeyPointClassifier(app_folder + '/HandGesture/model/keypoint_classifier/keypoint_classifier.tflite')

    point_history_classifier = PointHistoryClassifier(app_folder + '/HandGesture/model/point_history_classifier/point_history_classifier.tflite')

    # Read labels ###########################################################
    with open(app_folder + '/HandGesture/model/keypoint_classifier/keypoint_classifier_label.csv',
              encoding='utf-8-sig') as f:
        keypoint_classifier_labels = csv.reader(f)
        keypoint_classifier_labels = [
            row[0] for row in keypoint_classifier_labels
        ]
    with open(app_folder + '/HandGesture/model/point_history_classifier/point_history_classifier_label.csv',
            encoding='utf-8-sig') as f:
...
def logging_csv(number, mode, landmark_list, point_history_list):
    ...
    if mode == 1 and (0 <= number <= 9):
        csv_path = 'HandGesture/model/keypoint_classifier/keypoint.csv'
        with open(csv_path, 'a', newline="") as f:
            writer = csv.writer(f)
            writer.writerow([number, *landmark_list])
    if mode == 2 and (0 <= number <= 9):
        csv_path = 'HandGesture/model/point_history_classifier/point_history.csv'
        with open(csv_path, 'a', newline="") as f:
            writer = csv.writer(f)
